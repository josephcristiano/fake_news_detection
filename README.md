...
* _sample view of Dataset1_![Dataset1](https://github.com/josephcristiano/Fake_news_Detection/blob/main/dt1.PNG)
* _sample view of Dataset2_![Dataset2](https://github.com/josephcristiano/Fake_news_Detection/blob/main/dt2.PNG)
* _sample view of Dataset3_![Dataset3](https://github.com/josephcristiano/Fake_news_Detection/blob/main/dt3.PNG)
* _sample view of Dataset4_![Dataset4](https://github.com/josephcristiano/Fake_news_Detection/blob/main/dt4.PNG)
* _sample view of Dataset5_![Dataset5](https://github.com/josephcristiano/Fake_news_Detection/blob/main/dt5.PNG)
...
![accuracy score](https://github.com/josephcristiano/Fake_news_Detection/blob/main/download%20(4).png)
...
![modelbuildingm](https://github.com/josephcristiano/Fake_news_Detection/blob/main/Modelbulding11.PNG)
...
For Deploying we need to create a sample web interface which will get the text from the user and then send it to the flask server.In the flask server we will use the saved model model.plk to predict the news is real or fake and then return the result to the user through web interface.
 Example 1
![result1](https://github.com/josephcristiano/Fake_news_Detection/blob/main/1.PNG)
 Example 2
![result2](https://github.com/josephcristiano/Fake_news_Detection/blob/main/2.PNG)

#### Below is the Process Flow of the Model Deployment:
![model deployment](https://github.com/josephcristiano/Fake_news_Detection/blob/main/dep.PNG)
...
```Language
$ git clone  https://github.com/josephcristiano/Fake_news_Detection.git
```
...
```python
Model = joblib.load('C:/Users/Jose/Desktop/Fake_news_Detection/Model.pkl') #change the link according  to your folder/directory
```
